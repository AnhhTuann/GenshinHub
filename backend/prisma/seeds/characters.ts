...
const metaBuilds = [
  ...
  },
  {
    ...
    bestWeapons: [
      ...
      { rank: 3, name: "Kiếm Li Cốt", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tích lũy sát thương tăng dần theo thời gian, đem lại lượng sát thương đầu ra cực kỳ ổn định nếu được bảo kê tốt.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Kione.png" },
      ...
      { rank: 7, name: "Vua Biển Hàng Hiệu", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Vũ khí Event F2P cực tốt, tăng chỉ số Tấn Công và gia tăng trực tiếp lượng sát thương từ Kỹ Năng Nộ.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_MillenniaTuna.png" },
      { rank: 8, name: "Tuyết Vùi Tinh Ngân", subStat: "Sát Thương Vật Lý", isF2P: true, refinement: "R5", reason: "Lựa chọn rèn F2P tuyệt vời cung cấp chỉ số Sát Thương Vật Lý và tạo thêm băng rơi gây sát thương diện rộng.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Dragonfell.png" },
  ...
  },
  {
    characterId: "amber",
    bestWeapons: [
      { rank: 1, name: "Màn Ảo Thuật Đầu Tiên", subStat: "Sát Thương Bạo Kích", isF2P: false, refinement: "R1", reason: "Tấn công cơ bản cao và Sát Thương Bạo Kích cực lớn. Nội tại tăng sát thương Trọng Kích và tăng Tấn Công%, rất thích hợp cho lối chơi ngắm bắn của Amber.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Pledge.png" },
      { rank: 2, name: "Nhược Thủy", subStat: "Sát Thương Bạo Kích", isF2P: false, refinement: "R1", reason: "Chỉ số Sát Thương Bạo Kích khổng lồ (88.2%). Nội tại tăng sát thương khi ở gần kẻ địch, giúp tối ưu hóa lượng dame phản ứng Tan Chảy.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Kirin.png" },
      { rank: 3, name: "Sấm Sét Rung Động", subStat: "Sát Thương Bạo Kích", isF2P: false, refinement: "R1", reason: "Cung cấp lượng lớn Sát Thương Bạo Kích và nội tại tăng Tấn Công%, thích hợp cho lối chơi ngắm bắn kết hợp xả chiêu.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Narukami.png" },
      { rank: 4, name: "Cánh Thiên Không", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tỷ Lệ Bạo Kích cao và nội tại tăng thêm Sát Thương Bạo Kích%. Cung cấp thêm sát thương vật lý diện rộng thỉnh thoảng, rất đa dụng.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Dvalin.png" },
      { rank: 5, name: "Ngôi Sao Cực Đông", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Cung cấp Tỷ Lệ Bạo Kích. Nội tại tích tầng tăng Tấn Công% khi đánh trúng địch bằng Kỹ Năng Nguyên Tố, Nộ, Thường và Trọng Kích.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Worldbane.png" },
      { rank: 6, name: "Nỏ Kéo", subStat: "Tỷ Lệ Bạo Kích", isF2P: true, refinement: "R5", reason: "Lựa chọn 3 sao F2P cực mạnh nhờ lượng Tỷ Lệ Bạo Kích dồi dào và nội tại tăng mạnh sát thương đòn ngắm bắn trong cự ly gần.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Sling.png" },
      { rank: 7, name: "Cung Amos", subStat: "Tấn Công%", isF2P: false, refinement: "R1", reason: "Tấn Cống% cực cao. Tăng sát thương Tấn Công Thường và Ngắm Bắn, sát thương tăng thêm dựa trên thời gian bay của mũi tên.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Amos.png" },
      { rank: 8, name: "Con Đường Thợ Săn", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tỷ Lệ Bạo Kích cao. Nội tại tăng sát thương Trọng Kích dựa trên Tinh Thông Nguyên Tố, cực mạnh trong đội hình Tan Chảy.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Ayus.png" },
      { rank: 9, name: "Mỏ Cò Xuyên Thấu", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Vũ khí Event F2P tăng Tinh Thông Nguyên Tố sau khi đánh trúng địch bằng trọng kích, trực tiếp khuếch đại sát thương phản ứng.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Ibis.png" },
      { rank: 10, name: "Cung Sắc Xanh", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Dòng phụ Tỷ Lệ Bạo Kích và nội tại tạo gió lốc nhỏ gom quái, giúp Amber dễ dàng thực hiện các phát bắn chuẩn xác.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Viridescent.png" },
      { rank: 11, name: "Cung Trừ Ma", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Vũ khí rèn Inazuma F2P tăng mạnh sát thương đòn ngắm bắn, hiệu quả tối đa khi giữ đầy thanh năng lượng Nộ.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Bakufu.png" },
      { rank: 12, name: "Mẫu Đạm Nguyệt", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Cung cấp lượng lớn Tấn Công% sau khi bắn trúng điểm yếu của kẻ địch, lựa chọn ngắm bắn bắn tỉa rất tốt.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Proto.png" },
      { rank: 13, name: "Khúc Ca Tĩnh Lặng", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Vũ khí rèn Fontaine tăng mạnh sát thương đòn đánh sau khi nhận trị liệu, dễ kích hoạt khi đi cùng Healer.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Vorpal.png" },
      { rank: 14, name: "Bài Ca Hoa Gió", subStat: "Tinh Thông Nguyên Tố", isF2P: true, refinement: "R5", reason: "Tăng Tinh Thông Nguyên Tố và nhận thêm Tấn Công% sau khi dùng Kỹ Năng Nguyên Tố, hữu ích cho các pha phản ứng.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Fleurfair.png" },
      { rank: 15, name: "Tuyệt Huyền", subStat: "Tinh Thông Nguyên Tố", isF2P: true, refinement: "R5", reason: "Tăng mạnh sát thương Kỹ Năng Nguyên Tố và Kỹ Năng Nộ, thích hợp cho lối chơi quickswap ném bù nhìn rối và xả Nộ.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Troupe.png" },
      { rank: 16, name: "Lời Thề Xạ Thủ Thần", subStat: "Sát Thương Bạo Kích", isF2P: true, refinement: "R5", reason: "Vũ khí 3 sao F2P hoàn hảo cho lối chơi bắn điểm yếu nhờ lượng lớn Sát Thương Bạo Kích và nội tại tăng 48% dame điểm yếu.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Bow_Arjuna.png" },
  ...
  },
  {
    characterId: "dehya",
    bestWeapons: [
      { rank: 1, name: "Hải Đăng Bờ Biển Lau", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tấn công căn bản và Tỷ Lệ Bạo Kích cao. Nội tại tăng Tấn Công% và HP% sau khi Kỹ Năng Nguyên Tố đánh trúng địch.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Deshret.png" },
      { rank: 2, name: "Xích Giác Phá Thạch Đao", subStat: "Sát Thương Bạo Kích", isF2P: false, refinement: "R1", reason: "Sát Thương Bạo Kích cao. Tuy chỉ số Phòng Ngự không quá hữu ích nhưng lượng ST bạo cao giúp bù đắp sát thương tốt.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Itadorimaru.png" },
      { rank: 3, name: "Phán Quyết", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tấn công căn bản cao và Tỷ Lệ Bạo Kích tốt. Nội tại tăng sát thương Kỹ Năng Nguyên Tố sau phản ứng Kết Tinh.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_GoldenVerdict.png" },
      { rank: 4, name: "Đường Cùng Của Sói", subStat: "Tấn Công%", isF2P: false, refinement: "R1", reason: "Cung cấp lượng Tấn Công cực lớn cho Dehya và tăng sát thương cho toàn đội khi đánh trúng kẻ địch thấp máu.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Wolfmound.png" },
      { rank: 5, name: "Nanh Sơn Vương", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tỷ Lệ Bạo Kích cao và tăng sát thương đòn đánh sau khi trúng Kỹ Năng Nguyên Tố, rất phù hợp với lối chơi Burning.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_EmeraldSword.png" },
      { rank: 6, name: "Kiếm Li Cốt", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tăng sát thương đầu ra đáng kể khi tích đủ tầng nội tại, tuy nhiên cần duy trì khiên bảo vệ để tránh mất tầng.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Kione.png" },
      { rank: 7, name: "Đóa Hoa Tôn Màu Thép", subStat: "Tinh Thông Nguyên Tố", isF2P: true, refinement: "R5", reason: "Lựa chọn F2P cung cấp Tinh Thông Nguyên Tố và Tấn Công% sau khi kích hoạt phản ứng nguyên tố, rất mạnh cho lối chơi Burgeon.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Fleurfair.png" },
      { rank: 8, name: "Vũ Tài", subStat: "Tinh Thông Nguyên Tố", isF2P: false, refinement: "R5", reason: "Cung cấp Tinh Thông Nguyên Tố dồi dào và tăng mạnh sát thương lên kẻ địch bị ảnh hưởng bởi Thủy hoặc Lôi.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Perdue.png" },
      { rank: 9, name: "Bóng Tối Thủy Triều", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Vũ khí rèn F2P tăng Tấn Công% đáng kể khi nhận trị liệu, dễ kích hoạt khi đi kèm Healer.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Vorpal.png" },
      { rank: 10, name: "\"Bá Vương Tối Thượng Siêu Cấp Ma Kiếm\"", subStat: "Hiệu Quả Nạp Nguyên Tố", isF2P: true, refinement: "R5", reason: "Vũ khí sự kiện F2P tuyệt vời cung cấp Hiệu Quả Nạp giúp giảm áp lực nạp nộ và tăng Tấn Công% dựa trên Melusine đã giúp đỡ.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Champion.png" },
      { rank: 11, name: "Gậy Đàm Phán", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Cung cấp Tỷ Lệ Bạo Kích và tăng sát thương sau khi chịu ảnh hưởng của các trạng thái nguyên tố.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_BeastTamer.png" },
      { rank: 12, name: "Kiếm Vô Công", subStat: "Tấn Công%", isF2P: false, refinement: "R1", reason: "Tấn Công% cao và gia tăng hiệu quả khiên, hoạt động tốt nhất khi đi kèm nhân vật tạo khiên.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Kunwu.png" },
      { rank: 13, name: "Thiên Dương Rực Lửa", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Tỷ Lệ Bạo Kích tốt và tăng mạnh Tấn Công sau khi kích hoạt phản ứng Nguyên Tố Hỏa hoặc Thiêu Đốt.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_RadianceSword.png" },
      { rank: 14, name: "Thiên Không Kiêu Ngạo", subStat: "Hiệu Quả Nạp Nguyên Tố", isF2P: false, refinement: "R1", reason: "Cung cấp Hiệu Quả Nạp lớn giúp duy trì chu kỳ nộ nạp cho Dehya.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Dvalin.png" },
      { rank: 15, name: "Akuoumaru", subStat: "Tấn Công%", isF2P: false, refinement: "R5", reason: "Tăng sát thương Kỹ Năng Nộ dựa trên tổng năng lượng nộ của cả đội, tối ưu hóa sát thương nổ của Dehya.", iconUrl: "https://gi.yatta.moe/assets/UI/UI_EquipIcon_Claymore_Maria.png" }
    ],
    talentPriority: ["Burst", "Skill", "Normal Attack"],
    bestArtifacts: [
      {
