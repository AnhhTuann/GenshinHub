...
export const GET_CHARACTERS = `query GetCharacters { characters { id nameEn nameVi element rarity avatarUrl splashArtUrl weapon region birthday tier role recommendedC tierNoteEn tierNoteVi teams { id name rank description members { id characterId role roleDesc weapons artifacts substats } } } }`;
...
export const GET_MATERIALS = `query GetMaterials { materials { id nameEn nameVi type rarity iconUrl } }`;
