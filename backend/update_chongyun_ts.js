...
const chongyunPath = 'prisma/seeds/characters/chongyun.ts';
let chongyunContent = fs.readFileSync(chongyunPath, 'utf8');
chongyunContent = chongyunContent.replace('teams: [],', 'teams: ' + JSON.stringify(chongyunTeams, null, 2) + ',');
fs.writeFileSync(chongyunPath, chongyunContent);
console.log('chongyun.ts updated with teams.');
