...
export const GET_CHARACTER_BY_ID = `query GetCharacterById($id: String!) { character(id: $id) { id name title rarity element weapon region avatarUrl splashArtUrl lore baseStats fandomUrl talentPriority bestTeams bestWeapons { id name rank isF2P } bestArtifacts { setName pieces sands goblet circlet subStatsPriority } } }`;
