export const furina = {
    characterId: "furina",
    bestWeapons: [
      { rank: 1, nameVi: "Sắc Nước Lộng Lẫy", nameEn: "Splendor of Tranquil Waters", subStat: "Sát Thương Bạo Kích", isF2P: false, refinement: "R1", passiveDescVi: "Vũ khí trấn phái tốt nhất. Tăng mạnh sát thương Kỹ Năng Nguyên Tố và buff lượng HP tối đa khi máu đồng đội thay đổi liên tục.", passiveDescEn: "Vũ khí trấn phái tốt nhất. Tăng mạnh sát thương Kỹ Năng Nguyên Tố và buff lượng HP tối đa khi máu đồng đội thay đổi liên tục.", iconUrl: "/images/weapons/UI_EquipIcon_Sword_Regalis.png" },
