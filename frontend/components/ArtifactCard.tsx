      ...
      <div className="flex-1 min-w-0">
        <div className="flex flex-wrap items-center gap-2 mb-1">
          <h4 className="font-extrabold text-white text-base leading-tight font-display">
            {artifact.setName && !artifact.setName.includes('Thánh Di Vật') && !artifact.setName.includes('mix')
              ? artifact.setName
  ...
  return (
    <div className={`border rounded-2xl p-5 mb-4 transition-all duration-300 hover:border-white/10 hover:bg-[#151520]/50 hover:shadow-lg ${cardBg} group`}>
      ...
      <div className="border-t border-gray-900 pt-4">
        <span className="text-gray-500 text-[9px] font-black uppercase tracking-wider mb-2 block">Sub-Stats Priority</span>
