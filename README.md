...
- **Hướng dẫn Build:** Gợi ý cách lên đồ, ưu tiên kỹ năng, và cách xếp đội hình mạnh nhất cho từng nhân vật. Tham khảo tiến độ tại [meta_build_progress.md](./meta_build_progress.md).
- **Đồng bộ Dữ liệu Tự động:** Tích hợp script cào dữ liệu (crawl/seed) trực tiếp từ các nguồn uy tín để luôn cập nhật thông tin.

## 🏗️ Cấu trúc Dự án
Dự án được phát triển theo mô hình Client-Server (Monorepo), bao gồm:
- **[frontend/](./frontend/)**: Giao diện người dùng được xây dựng bằng **Next.js 15**, **React 19** và **TailwindCSS 4**, tập trung vào trải nghiệm mượt mà, tối ưu SEO.
