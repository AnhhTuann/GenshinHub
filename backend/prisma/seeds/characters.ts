...
const metaBuilds = [
  {
    ...
    bestWeapons: [
      ...
      { rank: 3, name: "Quyền Trượng Fjord", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R5", reason: "Vũ khí 4 sao BP cực tốt khi đi kèm đội hình có ít nhất 3 nguyên tố khác nhau để buff thêm Tinh Thông Nguyên Tố.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Shanty.png" },
      { rank: 4, name: "Khúc Ca Vườn Sáng", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Không khuyến nghị do dòng phụ tăng ST Vật Lý bị lãng phí và nội tại yêu cầu kích hoạt Kỹ Năng Nguyên Tố liên tục.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Muguet.png" },
      ...
      { rank: 7, name: "Hòa Phát Diên", subStat: "Tỷ Lệ Bạo Kích", isF2P: false, refinement: "R1", reason: "Cung cấp Tỷ Lệ Bạo Kích cao và cộng dồn Tấn Công ổn định, tuy nhiên cần thời gian để tích tầng nội tại.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Morax.png" },
      { rank: 8, name: "Thương Lập Kiếm", subStat: "Tấn Công%", isF2P: false, refinement: "R5", reason: "Cực mạnh trong đội hình nhiều nhân vật Liyue (như Xingqiu, Zhongli) để được tăng Tỷ Lệ Bạo Kích và Tấn Công%.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Lapis.png" },
      { rank: 9, name: "Thương Gió Gửi Thư", subStat: "Tấn Công%", isF2P: true, refinement: "R5", reason: "Vũ khí Event F2P tăng Tấn Công% và Tinh Thông Nguyên Tố sau khi kích hoạt phản ứng, lựa chọn tạm ổn khi thiếu thốn.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Windvane.png" },
      { rank: 10, name: "Thương Bạch Nhị", subStat: "Tỷ Lệ Bạo Kích", isF2P: true, refinement: "R5", reason: "Lựa chọn 3 sao F2P cực tốt ở giai đoạn đầu game nhờ buff Tỷ Lệ Bạo Kích và tăng sát thương đòn đánh thường.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Ruby.png" },
      ...
      { rank: 12, name: "Thương Thập Tự Kitain", subStat: "Tinh Thông Nguyên Tố", isF2P: true, refinement: "R5", reason: "Vũ khí rèn F2P cung cấp Tinh Thông Nguyên Tố, tuy nhiên nội tại tiêu hao năng lượng không thực sự hữu dụng với Hu Tao.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Bakufu.png" },
      { rank: 13, name: "Đền Đáp Của Công Lý", subStat: "HP%", isF2P: true, refinement: "R5", reason: "Không khuyến nghị do dòng phụ Hiệu Quả Nạp bị lãng phí và nội tại yêu cầu hồi máu, mâu thuẫn lối chơi thấp máu của cô.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Vorpal.png" }
    ],
    bestArtifacts: [
      {
  ...
  },
  {
    ...
    bestWeapons: [
      ...
      { rank: 9, name: "Nịnh Thần", subStat: "Tấn Công%", isF2P: false, refinement: "R1", reason: "Tăng hiệu quả Khiên và Tấn Công%, yêu cầu có nhân vật tạo khiên trong đội để phát huy tối đa sức mạnh.", iconUrl: "/images/weapons/UI_EquipIcon_Pole_Kunwu.png" },
