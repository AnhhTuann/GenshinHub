  ...
  return (
    <div className="flex flex-col items-center gap-3 w-full group/w text-center mt-2">
      ...
      <div className="flex flex-col w-full">
        <span className="text-white font-bold text-[14px] leading-snug break-words drop-shadow-md">
          {name}
        </span>
        <span className="text-amber-400/80 text-[10px] font-black uppercase tracking-[0.2em] mt-1.5">
          {label}
        </span>
      </div>
    </div>
  ...
  return (
    <>
      <div className="flex flex-col gap-3">
        ...
        <div
          className={`relative bg-[#0d0d14]/80 border ${borderColor} rounded-2xl overflow-hidden`}
